...
var mediaURLs = [
    ...
    'http://10.18.81.7/futureroom/CastVideo/media/Romance.mp4'];
var mediaTitles = [
    'Big Buck Bunny',
    'Elephant Dream',
    'Tears of Steel',
...
function moodChoose(mood) {
    switch (mood) {
        case romatic:
            loadMedia(mediaURLs[0])
            break;
        case work:
            loadMedia(mediaURLs[1])
            break;
        case hype:
            loadMedia(mediaURLs[2])
            break;
        case sleep:
            loadMedia(mediaURLs[3])
            break;
        case gang_gang:
            loadMedia(mediaURLs[4])
            break;
        case rage:
            loadMedia(mediaURLs[5])
            break;
    }
}
